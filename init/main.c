...
enum DEVICE_HWID g_ASUS_hwID=ZEUS_UNKNOWN;
...
EXPORT_SYMBOL(g_ASUS_hwID);
 ...
 static int set_hardware_id(char *str)
 {
	...
	if ( strcmp("15", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_EVB;
		printk("Kernel HW ID = ZEUS_EVB\n");
	}
	else if ( strcmp("0", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_EVB3;
		printk("Kernel HW ID = ZEUS_EVB3\n");
	}	
	else if ( strcmp("1", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_SR1;
		printk("Kernel HW ID = ZEUS_SR1\n");
	}
	else if ( strcmp("2", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_EVB5;
		printk("Kernel HW ID = ZEUS_EVB5\n");
	}	
	else if ( strcmp("3", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_ER1;
		printk("Kernel HW ID = ZEUS_ER1\n");
	}
	else if ( strcmp("4", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_ER2;
		printk("Kernel HW ID = ZEUS_ER2\n");
	}
	else if ( strcmp("5", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_PREPR;
		printk("Kernel HW ID = ZEUS_PREPR\n");
	}
	else if ( strcmp("6", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_PR1;
		printk("Kernel HW ID = ZEUS_PR1\n");
	}
	else if ( strcmp("7", str) == 0 )
	{
		g_ASUS_hwID = ZEUS_MP;
		printk("Kernel HW ID = ZEUS_MP\n");
	}
...
enum DEVICE_RFID g_ASUS_rfID=UNKNOWN_RF_ID;

EXPORT_SYMBOL(g_ASUS_rfID);

 static int set_rf_id(char *str)
 {
	if ( strcmp("0", str) == 0 )
	{
		g_ASUS_rfID = OPERATOR_4CA_WW_ID;
		printk("Kernel RF ID = OPERATOR_4CA_WW_ID\n");
	}	
	else if ( strcmp("1", str) == 0 )
	{
		g_ASUS_rfID = OPEN_CHANNEL_3CA_WW_ID;
		printk("Kernel RF ID = OPEN_CHANNEL_3CA_WW_ID\n");
	}
	else if ( strcmp("2", str) == 0 )
	{
		g_ASUS_rfID = OPEN_CHANNEL_3CA_TW_ID;
		printk("Kernel RF ID = OPEN_CHANNEL_3CA_TW_ID\n");
	}	
	else if ( strcmp("3", str) == 0 )
	{
		g_ASUS_rfID = OPEN_CHANNEL_3CA_ID_3;
		printk("Kernel RF ID = OPEN_CHANNEL_3CA_ID_3\n");
	}
	else if ( strcmp("4", str) == 0 )
	{
		g_ASUS_rfID = OPEN_CHANNEL_3CA_CN_ID;
		printk("Kernel RF ID = OPEN_CHANNEL_3CA_CN_ID\n");
	}
	else if ( strcmp("5", str) == 0 )
	{
		g_ASUS_rfID = OPERATOR_4CA_ID_5;
		printk("Kernel RF ID = OPERATOR_4CA_ID_5\n");
	}
	else if ( strcmp("6", str) == 0 )
	{
		g_ASUS_rfID = OPERATOR_4CA_ID_6;
		printk("Kernel RF ID = OPERATOR_4CA_ID_6\n");
	}
	else if ( strcmp("7", str) == 0 )
	{
		g_ASUS_rfID = OPERATOR_4CA_ID_7;
		printk("Kernel RF ID = OPERATOR_4CA_ID_7\n");
	}

	printk("g_ASUS_rfID = %d\n", g_ASUS_rfID);
	return 0;
}
...
//+++ ASUS_BSP : miniporting
enum DEVICE_HWID g_ASUS_prjID=ZEUS_UNKNOWN;
...
EXPORT_SYMBOL(g_ASUS_prjID);
 ...
 static int set_project_id(char *str)
 {
	...
	if ( strcmp("3", str) == 0 )
	{
		g_ASUS_prjID = ZEUS_PRJ_ID;
		printk("Kernel PRJ ID = ZEUS\n");
	}
	else
	{
...
//ASUS BSP Display, parsing lcd unique id +++
...
static int get_lcd_uniqueId(char *str)
{
    ...
    pr_info("[Display] lcd_unique_id = %s\n ", lcd_unique_id);
