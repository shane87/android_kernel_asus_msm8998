...
#define	COMMAND_REGISTER		0x04
	...
	#define CONTINUOUS_MEASURE_START 0x02
	#define CONTINUOUS_MEASURE_STOP	 0x03
...
#define	RESULT_REGISTER	0x08
	...
	#define	DISTANCE_ELISA_MASK	LASER_BIT_MASK(12,1)
...
#define RSLT_CONFIDENCE_REGISTER	0x0A
#define VEC_AMPL					LASER_BIT_MASK(14, 4)
#define VEC_AMPL_BIT_SHIFT			4

#define CMD_CFG_REGISTER_A	0x0C
#define REFRESH_RATE_MASK	LASER_BIT_MASK(6, 0)

#define	H2M_MBX	0x10
	#define	GET_CALIBRATION			0x06
	#define	GET_ELISA_CALIBRATION	0x09
...
#define	CMD_HFCFG0			0x20
	#define	OPERATION_MODE	LASER_BIT_MASK(14, 12)
	#define OP_BIT_SHIFT			12
	#define OP_MODE_LONG 			0
	#define OP_MODE_DEFAULT 		1
	#define OP_MODE_HIGH_SPEED 		2
	#define OP_MODE_HIGH_ACCURACY	3
	#define OP_MODE_CUSTOM			4

#define	CMD_HFCFG3			0x26
	#define	CONDITIONAL_MEASUREMENT_READY_EVT	BIT(11)
...
#define CAL_MSG_LEN_OLIVIA 27
#define CAL_MSG_LEN_ELISA 33
#define CAL_MSG_F0_OLIVIA 59
#define CAL_MSG_F0_ELISA 76
